...
def rnn_model(features, labels, mode):
  ...
  """LSTM单元"""
  #cell = tf.nn.run_cell.BasicLSTMCell(EMBEDDING_SIZE, forget_bias = 0.6, state_is_tuple=True ,activation='tanh')
...
def main(_):
    ...
    """Choose two types of models-- RNN model and BagOfWords model"""
    model_fn = rnn_model
    #if FLAGS.bow_model:
    ...
    print('LSTM网络的总耗时为{}秒'.format((end - start) / 1000))
